...
func updateMovie(w http.ResponseWriter, r *http.Request) {
	...
	//delete the movie of the given id that we have sent
...
func main() {
	...
	movies = append(movies, Movie{ID: "2", Isbn: "438290", Title: "Movie Two", Director: &Director{FirstName: "John", LastName: "Snow"}})
